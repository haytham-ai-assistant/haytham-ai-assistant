---
name: docx-to-mdbook
description: 将 Word 文档转换为 Markdown 并整合到海塞姆 mdBook 文档仓库。适合做任何文档转换任务和文档上传任务是阅读参考
license: MIT
metadata:
...
- [产品名称](products/（产品名称）/index.md)
  - [新文档标题](products/（产品名称）/（文档名）.md)
```

**更新总目录**（`src/SUMMARY.md`）：
```markdown
# 在对应章节添加
    - [文档标题](products/（产品名称）/（文档名）.md)
```
